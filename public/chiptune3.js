/*
	Vendored from https://github.com/DrSnuggles/chiptune (v3 branch).
	License: MIT (see public/licenses/chiptune3.LICENSE if added).

	Local modifications (search "CoolModFiles:"):
	  - Expose ChiptuneJsPlayer on window so it can be consumed from
	    non-module call sites in Player.tsx/EmbedPlayer.tsx.
...
// CoolModFiles: expose as global for Player.tsx / EmbedPlayer.tsx, which
// read the class name via the global declaration in globals.d.ts rather
// than importing the ES module directly.
